...
<div class="jumbotron rest" data-search="<?php echo mb_strtolower($rest['navn']).' '.implode(' ', $rest['under_rests_lowercase']); ?>">
  <div class="text-center">
    <img src="/img/rest/<?php echo $rest['logo']; ?>" class="rounded" alt="" width="200px">
  </div>
...
<?php foreach ($this->rests as $rest): ?>
  <div class="col-sm-6">
    <div class="card" data-search="<?php echo mb_strtolower($rest['navn']).' '.implode(' ', $rest['under_rests_lowercase']); ?>">
      <div class="card-body">
