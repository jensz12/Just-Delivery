...
<main class="container">
	...
	<div class="card">
		<div class="card-body">
			<p>Just Eat er <b>ikke</b> ansvarlige for indholdet på denne side. Fejl og forbedringer kan sendes til <a href="mailto:jens@jensz12.com">Jens</a>. Restaurant listen er sidst opdateret i marts <?php echo date("Y")?>. Aalborg ❤️</p>
		</div>
	</div>
</main>
